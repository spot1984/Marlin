 ...
 */
//DSW 20171217 #define E0_AUTO_FAN_PIN -1
#define E0_AUTO_FAN_PIN 11  // DSW 20171217 Added fan extender (unused PWM is pin 6)
...
// Add support for experimental filament exchange support M600; requires display
   ...
   #define FILAMENT_CHANGE_FEATURE             // Enable filament exchange menu and M600 g-code (used for runout sensor too)
    ...
    #define FILAMENT_CHANGE_X_POS 122           // X position of hotend (122 is centered, 202 is right side on Sam Bell)
