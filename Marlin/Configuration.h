...
//DSW#define STRING_CONFIG_H_AUTHOR "(Tom, 2017-03-19)" // Who made the changes.
#define STRING_CONFIG_H_AUTHOR "(DSW, 2017-06-21)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sam Bell"
...
// DSW uncomment this line to use the default motion settings for a Prusa i3 MK2
...
//#define Z_SERVO_ANGLES {45,150} // Z Servo Deploy and Stow angles
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 10  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -10.17  // Z offset: -below +above  [the nozzle]
...
// DSW -10 to move off center hole
