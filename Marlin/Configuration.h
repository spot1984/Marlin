/**
 * Marlin 3D Printer Firmware - (Mandelbot 1.1.x - 1.9)
...
#define STRING_CONFIG_H_AUTHOR "(Kevin, 2019-01-01)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EFB   // MANDELBOT KEVIN:  EFB is Extruder Fan Bed
#endif
 ...
 */
// DSW #define Z_CLEARANCE_DEPLOY_PROBE    5 // Z Clearance for Deploy/Stow
// DSW #define Z_CLEARANCE_BETWEEN_PROBES  3 // Z Clearance between probe points
...
#define Z_PROBE_OFFSET_RANGE_MIN -40 // KEVIN MANDELBOT, was -20.   why restrict?? my probe is -19 to -21 so... 20 sucks!
#define Z_PROBE_OFFSET_RANGE_MAX 40  // KEVIN MANDELBOT, was 20.   why restrict??  my probe is -19 to -21 so... 20 sucks!
...
#define MANUAL_X_HOME_POS -3  // MANDELBOT KEVIN offset of nozzle from probe
#define MANUAL_Y_HOME_POS -13 // MANDELBOT KEVIN offset of nozzle from probe
#define MANUAL_Z_HOME_POS 0.0 // Distance between the nozzle to printbed after homing  (KEVIN why was this 0.5??  set to 0 so we can figure sane zoffsets)
...
#define Z_SAFE_HOMING
  ...
  // DSW -10 to move off center hole // MANDELBOT KEVIN
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 2)-10    // X point for Z homing when homing all axis (G28).
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC (140.97*2.0)
  #define XY_DIAG_BD (141.02*2.0)
  #define XY_SIDE_AD (99.99*2.0)
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC (140.40*2.0)
    #define XZ_DIAG_BD (142.22*2.0)
    #define XZ_SIDE_AD (99.75*2.0)
    #define YZ_DIAG_AC (140.67*2.0)
    #define YZ_DIAG_BD (141.83*2.0)
    #define YZ_SIDE_AD (99.75*2.0)
 ...
 */
#define NOZZLE_PARK_FEATURE   // MANDELBOT KEVIN

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z }
  //#define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }
  #define NOZZLE_PARK_POINT { 122,0,30 }    // MANDELBOT KEVIN
 ...
 */
#define SPI_SPEED SPI_HALF_SPEED  // MANDELBOT KEVIN
 ...
 */
#define SD_CHECK_AND_RETRY  // MANDELBOT KEVIN
...
//
#define ENCODER_PULSES_PER_STEP 4 // MANDELBOT KEVIN

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
//#define ENCODER_STEPS_PER_MENU_ITEM 1 // MANDELBOT KEVIN
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER // MANDELBOT KEVIN
...
//
#define ULTRA_LCD   // MANDELBOT KEVIN
